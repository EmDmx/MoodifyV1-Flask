...
def happylist(sp,art_id):
    ...
    recs=sp.recommendations(limit=20,seed_artists=artist[:1],seed_tracks=track_id[:5],country='TR',target_danceability=danceability,target_valence=valence,target_energy=energy)
